...
import com.vulenhtho.snow.controller.web.LoginController;
import com.vulenhtho.snow.dto.*;
import com.vulenhtho.snow.dto.enumeration.PaymentMethod;
import com.vulenhtho.snow.dto.request.*;
import com.vulenhtho.snow.dto.response.ItemsForCartAndHeader;
import com.vulenhtho.snow.dto.response.ProductFilterWebResponse;
import com.vulenhtho.snow.dto.response.ProductWebResponse;
import com.vulenhtho.snow.dto.response.ProductWebWindowViewResponseDTO;
import com.vulenhtho.snow.security.CustomUserDetail;
...
import static com.vulenhtho.snow.util.CommonUtils.convertToVnCurrency;
...
public class ProductServiceImpl implements ProductService {
    ...
    public ModelAndView getWelcomePage() {
        ModelAndView modelAndView = new ModelAndView("/web/home-page");
        ...
        if (!HttpStatus.OK.equals(allPageDataResponse.getStatusCode())) {
            return new ModelAndView("/web/home-page");
        }
    ...
    public ModelAndView getListProductPage(FilterProductRequest filter, boolean forAdmin) {
        ...
        if (!HttpStatus.OK.equals(productPageRequest.getStatusCode())) {
            return new ModelAndView("web/product/product-list-new");
        }
    ...
    public ModelAndView getDetailProductPage(Long productId) {
        ModelAndView modelAndView = new ModelAndView("/web/product/product-detail-new");
        ...
        if (!HttpStatus.OK.equals(productResponseEntity.getStatusCode())) {
            return new ModelAndView("/web/product/product-detail-new");
        }
    ...
    private void setProductHasSameSubCategory(ModelAndView modelAndView, Long subCategoryId) {
        ...
        if (products.size() > 4 ){
            List<ProductWebWindowViewResponseDTO> newProducts = new ArrayList<>();
            for (int i = 0; i < 4; i++) {
