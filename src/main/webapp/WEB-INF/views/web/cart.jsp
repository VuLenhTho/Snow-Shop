...
<section class="page-header" style="font-family: Helvetica,Arial">
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <div class="content">
                    <h2 class="page-name" style="font-family: Helvetica,Arial">Giỏ hàng</h2>
                    <ol class="breadcrumb">
                                ...
                                <div class="col-md-12 mb-12" id="divPaymentInfo4">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-9 mb-9">
                                            <b style="margin-bottom: auto;margin-top: 25px">VietinBank:  </b><p style="margin-bottom: auto;margin-top: 25px; display: inline-block"> 021532554788 - VU THI TUYET</p>
                                        </div>
                                    </div>
