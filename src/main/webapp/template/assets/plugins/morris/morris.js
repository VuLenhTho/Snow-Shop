(function () {
    var t, i, e, o, s = [].slice, n = function (t, i) {
        return function () {
            return t.apply(i, arguments)
        }
    }, r = {}.hasOwnProperty, h = function (t, i) {
        for (var e in i) r.call(i, e) && (t[e] = i[e]);

        function o() {
            this.constructor = t
        }

        return o.prototype = i.prototype, t.prototype = new o, t.__super__ = i.prototype, t
    }, a = [].indexOf || function (t) {
        for (var i = 0, e = this.length; i < e; i++) if (i in this && this[i] === t) return i;
        return -1
    };
    i = window.Morris = {}, t = jQuery, i.EventEmitter = function () {
        function t() {
        }
        ...
        return t.prototype.on = function (t, i) {
            ...
            var t, i, e, o, n, r, h;
            if (e = arguments[0], t = 2 <= arguments.length ? s.call(arguments, 1) : [], null != this.handlers && null != this.handlers[e]) {
                for (h = [], o = 0, n = (r = this.handlers[e]).length; o < n; o++) i = r[o], h.push(i.apply(null, t));
                return h
            }
        }, t
    }(), i.commas = function (t) {
        ...
        function o(i) {
            ...
            var e = this;
            if ("string" == typeof i.element ? this.el = t(document.getElementById(i.element)) : this.el = t(i.element), null == this.el || 0 === this.el.length) throw new Error("Graph container element not found");
            "static" === this.el.css("position") && this.el.css("position", "relative"), this.options = t.extend({}, this.gridDefaults, this.defaults || {}, i), "string" == typeof this.options.units && (this.options.postUnits = i.units), this.raphael = new Raphael(this.el[0]), this.elementWidth = null, this.elementHeight = null, this.dirty = !1, this.selectFrom = null, this.init && this.init(), this.setData(this.options.data), this.el.bind("mousemove", function (t) {
                var i, o, s, n;
                return o = e.el.offset(), n = t.pageX - o.left, e.selectFrom ? (i = e.data[e.hitTest(Math.min(n, e.selectFrom))]._x, s = e.data[e.hitTest(Math.max(n, e.selectFrom))]._x - i, e.selectionRect.attr({
                    x: i,
                    width: s
                })) : e.fire("hovermove", n, t.pageY - o.top)
                ...
                var i, o;
                return o = t.originalEvent.touches[0] || t.originalEvent.changedTouches[0], i = e.el.offset(), e.fire("hovermove", o.pageX - i.left, o.pageY - i.top)
            }), this.el.bind("click", function (t) {
                var i;
                return i = e.el.offset(), e.fire("gridclick", t.pageX - i.left, t.pageY - i.top)
                ...
                var i;
                return i = e.el.offset(), e.endRange(t.pageX - i.left), e.fire("hovermove", t.pageX - i.left, t.pageY - i.top)
        ...
        return h(o, e), o.prototype.gridDefaults = {
            dateFormat: null,
            axes: !0,
            grid: !0,
            gridLineColor: "#aaa",
            ...
            return null == e && (e = !0), this.options.data = t, null == t || 0 === t.length ? (this.data = [], this.raphael.clear(), void (null != this.hover && this.hover.hide())) : (f = this.cumulative ? 0 : null, g = this.cumulative ? 0 : null, this.options.goals.length > 0 && (h = Math.min.apply(Math, this.options.goals), r = Math.max.apply(Math, this.options.goals), g = null != g ? Math.min(g, h) : h, f = null != f ? Math.max(f, r) : r), this.data = function () {
                var e, o, r;
                for (r = [], n = e = 0, o = t.length; e < o; n = ++e) l = t[n], (a = {src: l}).label = l[this.options.xkey], this.options.parseTime ? (a.x = i.parseDate(a.label), this.options.dateFormat ? a.label = this.options.dateFormat(a.x) : "number" == typeof a.label && (a.label = new Date(a.label).toString())) : (a.x = n, this.options.xLabelFormat && (a.label = this.options.xLabelFormat(a))), u = 0, a.y = function () {
                    var t, i, e, o;
                    for (e = this.options.ykeys, o = [], s = t = 0, i = e.length; t < i; s = ++t) d = e[s], "string" == typeof (m = l[d]) && (m = parseFloat(m)), null != m && "number" != typeof m && (m = null), null != m && (this.cumulative ? u += m : null != f ? (f = Math.max(m, f), g = Math.min(m, g)) : f = g = m), this.cumulative && null != u && (f = Math.max(u, f), g = Math.min(u, g)), o.push(m);
                    return o
                }.call(this), r.push(a);
                return r
                ...
                var t, e, s, n;
                for (n = [], t = 0, e = (s = this.options.events).length; t < e; t++) o = s[t], n.push(i.parseDate(o));
                return n
            ...
            var e, o;
            return "string" == typeof (e = this.options["y" + t]) ? "auto" === e.slice(0, 4) ? e.length > 5 ? (o = parseInt(e.slice(5), 10), null == i ? o : Math[t](i, o)) : null != i ? i : 0 : parseInt(e, 10) : e
        }, o.prototype.autoGridLines = function (t, i, e) {
            var o, s, n, r, h, a, l, p, u;
            return h = i - t, u = Math.floor(Math.log(h) / Math.log(10)), l = Math.pow(10, u), s = Math.floor(t / l) * l, o = Math.ceil(i / l) * l, a = (o - s) / (e - 1), 1 === l && a > 1 && Math.ceil(a) !== a && (a = Math.ceil(a), o = s + a * (e - 1)), s < 0 && o > 0 && (s = Math.floor(t / a) * a, o = Math.ceil(i / a) * a), a < 1 ? (r = Math.floor(Math.log(a) / Math.log(10)), n = function () {
                var t, i;
            ...
            if (s = this.el.width(), e = this.el.height(), (this.elementWidth !== s || this.elementHeight !== e || this.dirty) && (this.elementWidth = s, this.elementHeight = e, this.dirty = !1, this.left = this.options.padding, this.right = this.elementWidth - this.options.padding, this.top = this.options.padding, this.bottom = this.elementHeight - this.options.padding, !0 !== (r = this.options.axes) && "both" !== r && "y" !== r || (n = function () {
                var t, e, o, s;
                for (s = [], t = 0, e = (o = this.grid).length; t < e; t++) i = o[t], s.push(this.measureText(this.yAxisFormat(i)).width);
                return s
            ...
            return "function" == typeof this.options.yLabelFormat ? this.options.yLabelFormat(t) : "" + this.options.preUnits + i.commas(t) + this.options.postUnits
            ...
            var i, e;
            if (this.selectFrom) return e = Math.min(this.selectFrom, t), i = Math.max(this.selectFrom, t), this.options.rangeSelect.call(this.el, {
    ...
    }(i.EventEmitter), i.parseDate = function (t) {
        ...
        function e(e) {
            null == e && (e = {}), this.options = t.extend({}, i.Hover.defaults, e), this.el = t("<div class='" + this.options.class + "'></div>"), this.el.hide(), this.options.parent.append(this.el)
        }

        return e.defaults = {class: "morris-hover morris-default-style"}, e.prototype.update = function (t, i, e) {
            ...
            var e, o, s, n, r, h;
            return r = this.options.parent.innerWidth(), n = this.options.parent.innerHeight(), o = this.el.outerWidth(), e = this.el.outerHeight(), s = Math.min(Math.max(0, t - o / 2), r - o), null != i ? (h = i - e - 10) < 0 && (h = i + 10) + e > n && (h = n / 2 - e / 2) : h = n / 2 - e / 2, this.el.css({
                left: s + "px",
                top: parseInt(h) + "px"
            })
        ...
        function e(t) {
            if (this.hilight = n(this.hilight, this), this.onHoverOut = n(this.onHoverOut, this), this.onHoverMove = n(this.onHoverMove, this), this.onGridClick = n(this.onGridClick, this), !(this instanceof i.Line)) return new i.Line(t);
            e.__super__.constructor.call(this, t)
        }

        return h(e, t), e.prototype.init = function () {
            if ("always" !== this.options.hideHover) return this.hover = new i.Hover({parent: this.el}), this.on("hovermove", this.onHoverMove), this.on("hoverout", this.onHoverOut), this.on("gridclick", this.onGridClick)
            ...
            var t, i, e, o, s, n;
            for (n = [], e = 0, o = (s = this.data).length; e < o; e++) (t = s[e])._x = this.transX(t.x), t._y = function () {
                var e, o, s, n;
                for (n = [], e = 0, o = (s = t.y).length; e < o; e++) null != (i = s[e]) ? n.push(this.transY(i)) : n.push(i);
                return n
            }.call(this), n.push(t._ymax = Math.min.apply(Math, [this.bottom].concat(function () {
                var e, o, s, n;
                for (n = [], e = 0, o = (s = t._y).length; e < o; e++) null != (i = s[e]) && n.push(i);
                return n
            }())));
            return n
        ...
        }, e.prototype.onHoverMove = function (t, i) {
            var e;
            ...
            return this.paths = function () {
                var n, r, h, l;
                for (l = [], e = n = 0, r = this.options.ykeys.length; 0 <= r ? n < r : n > r; e = 0 <= r ? ++n : --n) s = "boolean" == typeof this.options.smooth ? this.options.smooth : (h = this.options.ykeys[e], a.call(this.options.smooth, h) >= 0), (t = function () {
                    var t, i, s, n;
            ...
            for (h = this.bottom + this.options.padding / 2, n = null, s = null, t = function (t, i) {
                ...
                var t, i, e, o;
                for (o = [], t = 0, i = (e = this.data).length; t < i; t++) r = e[t], o.push([r.label, r.x]);
                return o
            }.call(this)).reverse(), p = [], a = 0, l = o.length; a < l; a++) e = o[a], p.push(t(e[0], e[1]));
            return p
            ...
            var i, e, o, s, n, r;
            for (this.seriesPoints[t] = [], r = [], o = 0, s = (n = this.data).length; o < s; o++) i = null, null != (e = n[o])._y[t] && (i = this.drawLinePoint(e._x, e._y[t], this.colorFor(e, t, "point"), t)), r.push(this.seriesPoints[t].push(i));
            return r
        }, e.prototype._drawLineFor = function (t) {
            var i;
            if (null !== (i = this.paths[t])) return this.drawLinePath(i, this.colorFor(null, t, "line"), t)
        }, e.createPath = function (t, e, o) {
            var s, n, r, h, a, l, p, u, c, d;
            for (p = "", e && (r = i.Line.gradients(t)), u = {y: null}, h = c = 0, d = t.length; c < d; h = ++c) null != (s = t[h]).y && (null != u.y ? e ? (n = r[h], l = r[h - 1], a = (s.x - u.x) / 4, p += "C" + (u.x + a) + "," + Math.min(o, u.y + a * l) + "," + (s.x - a) + "," + Math.min(o, s.y - a * n) + "," + s.x + "," + s.y) : p += "L" + s.x + "," + s.y : e && null == r[h] || (p += "M" + s.x + "," + s.y)), u = s;
            return p
        }, e.gradients = function (t) {
            var i, e, o, s, n, r, h, a;
            for (e = function (t, i) {
                return (t.y - i.y) / (t.x - i.x)
            }, a = [], o = r = 0, h = t.length; r < h; o = ++r) null != (i = t[o]).y ? (s = t[o + 1] || {y: null}, null != (n = t[o - 1] || {y: null}).y && null != s.y ? a.push(e(n, s)) : null != n.y ? a.push(e(n, i)) : null != s.y ? a.push(e(i, s)) : a.push(null)) : a.push(null);
            return a
        ...
        if (l = 200 * (o - e) / s, a = new Date(e), void 0 === (d = i.LABEL_SPECS[n])) for (g = 0, m = (y = i.AUTO_LABEL_ORDER).length; g < m; g++) if (p = y[g], l >= (c = i.LABEL_SPECS[p]).span) {
            d = c;
            break
        }
        for (void 0 === d && (d = i.LABEL_SPECS.second), r && (d = t.extend({}, d, {fmt: r})), h = d.start(a), u = []; (f = h.getTime()) <= o;) f >= e && u.push([d.fmt(h), f]), d.incr(h);
        return u
    }, e = function (t) {
        return {
        ...
        return {
            span: 1e3 * t, start: function (t) {
                ...
                return i.pad2(t.getHours()) + ":" + i.pad2(t.getMinutes()) + ":" + i.pad2(t.getSeconds())
            }, incr: function (i) {
        ...
        week: {
            span: 6048e5, start: function (t) {
                ...
                return t.getFullYear() + "-" + i.pad2(t.getMonth() + 1) + "-" + i.pad2(t.getDate())
            }, incr: function (t) {
        ...
        "5sec": o(5),
        second: o(1)
    }, i.AUTO_LABEL_ORDER = ["decade", "year", "month", "week", "day", "hour", "30min", "15min", "10min", "5min", "minute", "30sec", "15sec", "10sec", "5sec", "second"], i.Area = function (e) {
        var o;

        function s(e) {
            var n;
            if (!(this instanceof i.Area)) return new i.Area(e);
            n = t.extend({}, o, e), this.cumulative = !n.behaveLikeLine, "auto" === n.fillOpacity && (n.fillOpacity = n.behaveLikeLine ? .8 : 1), s.__super__.constructor.call(this, n)
        }

        return h(s, e), o = {fillOpacity: "auto", behaveLikeLine: !1}, s.prototype.calcPoints = function () {
            var t, i, e, o, s, n, r;
            for (r = [], o = 0, s = (n = this.data).length; o < s; o++) (t = n[o])._x = this.transX(t.x), i = 0, t._y = function () {
                var o, s, n, r;
                for (r = [], o = 0, s = (n = t.y).length; o < s; o++) e = n[o], this.options.behaveLikeLine ? r.push(this.transY(e)) : (i += e || 0, r.push(this.transY(i)));
                return r
            }.call(this), r.push(t._ymax = Math.max.apply(Math, t._y));
            return r
        }, s.prototype.drawSeries = function () {
            var t, i, e, o, s, n, r, h;
            ...
            return h
        }, s.prototype._drawFillFor = function (t) {
            var i;
            if (null !== (i = this.paths[t])) return i = i + "L" + this.transX(this.xmax) + "," + this.bottom + "L" + this.transX(this.xmin) + "," + this.bottom + "Z", this.drawFilledPath(i, this.fillForSeries(t))
        }, s.prototype.fillForSeries = function (t) {
            var i;
        ...
        }, s.prototype.drawFilledPath = function (t, i) {
            return this.raphael.path(t).attr("fill", i).attr("fill-opacity", this.options.fillOpacity).attr("stroke", "none")
        }, s
    }(i.Line), i.Bar = function (e) {
        function o(e) {
            if (this.onHoverOut = n(this.onHoverOut, this), this.onHoverMove = n(this.onHoverMove, this), this.onGridClick = n(this.onGridClick, this), !(this instanceof i.Bar)) return new i.Bar(e);
            o.__super__.constructor.call(this, t.extend({}, e, {parseTime: !1}))
        }

        return h(o, e), o.prototype.init = function () {
            if (this.cumulative = this.options.stacked, "always" !== this.options.hideHover) return this.hover = new i.Hover({parent: this.el}), this.on("hovermove", this.onHoverMove), this.on("hoverout", this.onHoverOut), this.on("gridclick", this.onGridClick)
            ...
            var t, i, e, o, s, n, r;
            for (r = [], t = o = 0, s = (n = this.data).length; o < s; t = ++o) (i = n[t])._x = this.left + this.width * (t + .5) / this.data.length, r.push(i._y = function () {
                var t, o, s, n;
                for (n = [], t = 0, o = (s = i.y).length; t < o; t++) null != (e = s[t]) ? n.push(this.transY(e)) : n.push(null);
                return n
            }.call(this));
            return r
            ...
            for (l = this.bottom + (this.options.xAxisLabelTopPadding || this.options.padding / 2), r = null, n = null, c = [], t = p = 0, u = this.data.length; 0 <= u ? p < u : p > u; t = 0 <= u ? ++p : --p) h = this.data[this.data.length - 1 - t], a = (i = this.drawXAxisLabel(h._x, l, h.label)).getBBox(), i.transform("r" + -this.options.xLabelAngle), e = i.getBBox(), i.transform("t0," + e.height / 2 + "..."), 0 !== this.options.xLabelAngle && (s = -.5 * a.width * Math.cos(this.options.xLabelAngle * Math.PI / 180), i.transform("t" + s + ",0...")), (null == r || r >= e.x + e.width || null != n && n >= e.x) && e.x >= 0 && e.x + e.width < this.el.width() ? (0 !== this.options.xLabelAngle && (o = 1.25 * this.options.gridTextSize / Math.sin(this.options.xLabelAngle * Math.PI / 180), n = e.x - o), c.push(r = e.x - this.options.xLabelMargin)) : c.push(i.remove());
            return c
        }, o.prototype.drawSeries = function () {
            var t, i, e, o, s, n, r, h, a, l, p, u, c, d, f;
            return e = this.width / this.options.data.length, h = this.options.stacked ? 1 : this.options.ykeys.length, t = (e * this.options.barSizeRatio - this.options.barGap * (h - 1)) / h, this.options.barSize && (t = Math.min(t, this.options.barSize)), u = e - t * h - this.options.barGap * (h - 1), r = u / 2, f = this.ymin <= 0 && this.ymax >= 0 ? this.transY(0) : null, this.bars = function () {
                var h, u, g, m;
                for (g = this.data, m = [], o = h = 0, u = g.length; h < u; o = ++h) a = g[o], s = 0, m.push(function () {
                    var h, u, g, m;
                    for (g = a._y, m = [], l = h = 0, u = g.length; h < u; l = ++h) null !== (d = g[l]) ? (f ? (c = Math.min(d, f), i = Math.max(d, f)) : (c = d, i = this.bottom), n = this.left + o * e + r, this.options.stacked || (n += l * (t + this.options.barGap)), p = i - c, this.options.verticalGridCondition && this.options.verticalGridCondition(a.x) && this.drawBar(this.left + o * e, this.top, e, Math.abs(this.top - this.bottom), this.options.verticalGridColor, this.options.verticalGridOpacity, this.options.barRadius), this.options.stacked && (c -= s), this.drawBar(n, c, t, p, this.colorFor(a, l, "bar"), this.options.barOpacity, this.options.barRadius), m.push(s += p)) : m.push(null);
                    return m
                }.call(this));
                return m
            }.call(this)
            ...
            var e;
            return e = this.hitTest(t), this.fire("click", e, this.data[e].src, t, i)
        }, o.prototype.onHoverMove = function (t, i) {
            var e, o;
            return e = this.hitTest(t), (o = this.hover).update.apply(o, this.hoverContentForRow(e))
            ...
            var h;
            return (0 === (h = Math.max.apply(Math, r)) || h > o ? this.raphael.rect(t, i, e, o) : this.raphael.path(this.roundedRect(t, i, e, o, r))).attr("fill", s).attr("fill-opacity", n).attr("stroke", "none")
    ...
    }(i.Grid), i.Donut = function (e) {
        function o(e) {
            this.resizeHandler = n(this.resizeHandler, this), this.select = n(this.select, this), this.click = n(this.click, this);
            var o = this;
            if (!(this instanceof i.Donut)) return new i.Donut(e);
            if (this.options = t.extend({}, this.defaults, e), "string" == typeof e.element ? this.el = t(document.getElementById(e.element)) : this.el = t(e.element), null === this.el || 0 === this.el.length) throw new Error("Graph placeholder not found.");
            void 0 !== e.data && 0 !== e.data.length && (this.raphael = new Raphael(this.el[0]), this.options.resize && t(window).bind("resize", function (t) {
                return null != o.timeoutId && window.clearTimeout(o.timeoutId), o.timeoutId = window.setTimeout(o.resizeHandler, 100)
            }), this.setData(e.data))
        }

        return h(o, e), o.prototype.defaults = {
            ...
            for (this.raphael.clear(), e = this.el.width() / 2, o = this.el.height() / 2, c = (Math.min(e, o) - 10) / 3, u = 0, d = 0, m = (x = this.values).length; d < m; d++) u += x[d];
            for (a = 5 / (2 * c), t = 1.9999 * Math.PI - a * this.data.length, r = 0, n = 0, this.segments = [], s = f = 0, y = (w = this.values).length; f < y; s = ++f) l = r + a + t * (w[s] / u), (p = new i.DonutSegment(e, o, 2 * c, c, r, l, this.data[s].color || this.options.colors[n % this.options.colors.length], this.options.backgroundColor, n, this.raphael)).render(), this.segments.push(p), p.on("hover", this.select), p.on("click", this.click), r = l, n += 1;
            for (this.text1 = this.drawEmptyDonutLabel(e, o - 10, this.options.labelColor, 15, 800), this.text2 = this.drawEmptyDonutLabel(e, o + 10, this.options.labelColor, 14), h = Math.max.apply(Math, this.values), n = 0, M = [], g = 0, v = (b = this.values).length; g < v; g++) {
                if (b[g] === h) {
                    this.select(n);
                    break
                }
            ...
            return this.data = t, this.values = function () {
                var t, e, o, s;
                for (s = [], t = 0, e = (o = this.data).length; t < e; t++) i = o[t], s.push(parseFloat(i.value));
                return s
            ...
            return n = 1.8 * (e = 2 * (Math.min(this.el.width() / 2, this.el.height() / 2) - 10) / 3), s = e / 2, o = e / 3, this.text1.attr({
                text: t,
                transform: ""
            }), r = this.text1.getBBox(), h = Math.min(n / r.width, s / r.height), this.text1.attr({transform: "S" + h + "," + h + "," + (r.x + r.width / 2) + "," + (r.y + r.height)}), this.text2.attr({
                text: i,
                transform: ""
            }), a = this.text2.getBBox(), l = Math.min(n / a.width, o / a.height), this.text2.attr({transform: "S" + l + "," + l + "," + (a.x + a.width / 2) + "," + a.y})
        ...
        return h(i, t), i.prototype.calcArcPoints = function (t) {
            ...
            return this.raphael.path(t).attr({stroke: i, "stroke-width": 2, opacity: 0})
        }, i.prototype.drawDonutSegment = function (t, i, e, o, s) {
            return this.raphael.path(t).attr({fill: i, stroke: e, "stroke-width": 3}).hover(o).click(s)
